...
const glm::uvec2 Application::initial_resolution_ = {640u, 480u};
const float Application::initial_aspect_ratio = float(initial_resolution_.x) / float(initial_resolution_.y);
